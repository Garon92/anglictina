...
import { g92Pwa, g92NotFoundPage } from './src/kit/pwa.ts';
...
export default defineConfig({
  ...
  plugins: [
    ...
    // dist/404.html = the app itself, so unknown deep links render the in-app "Tahle stránka neexistuje".
    g92NotFoundPage('anglictina', { spa: true }),
  ],
  build: {
    outDir: 'dist',
    target: 'es2022',
