    ...
    questions: [
      {
        ...
        options: ['At six o\'clock', 'At eight o\'clock', 'At seven o\'clock', 'At five o\'clock'],
        answerIndex: 2,
      },
      {
        id: 'read_daily_01_q2',
        ...
        options: ['By car', 'By bus', 'On foot', 'By bike'],
        answerIndex: 1,
      },
      {
        id: 'read_daily_01_q3',
        type: 'truefalse',
        question: 'The narrator has lunch at home.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
      {
    ...
    questions: [
      {
        ...
        options: ['In Prague', 'In Olomouc', 'In Brno', 'In a village'],
        answerIndex: 2,
      },
      {
        ...
        options: ['An engineer', 'A doctor', 'A teacher', 'A driver'],
        answerIndex: 0,
      },
      {
        id: 'read_family_01_q3',
        type: 'truefalse',
        question: 'Tomáš\'s sister is younger than him.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
      {
        ...
        options: ['A dog', 'A hamster', 'A rabbit', 'A cat'],
        answerIndex: 3,
      },
    ],
  },
  ...
  // ─── 3. A Trip to London (A2) ────────────────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['Dinosaur bones', 'Famous paintings', 'The Crown Jewels', 'Wax figures'],
        answerIndex: 2,
      },
      {
        id: 'read_travel_01_q3',
        type: 'truefalse',
        question: 'The British Museum was free to enter.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
      {
    ...
    questions: [
      {
        ...
        options: ['At least two', 'At least three', 'At least four', 'At least five'],
        answerIndex: 3,
      },
      {
        id: 'read_food_01_q2',
      ...
      },
      {
        ...
        options: [
          ...
          'You feel hungry and eat a big dinner',
          'You lose weight and feel more active',
          'You concentrate better in the afternoon',
        ],
        answerIndex: 0,
      },
      {
    ...
    questions: [
      {
        ...
        options: ['Three times a week', 'Four times a week', 'Five times a week', 'Every day'],
        answerIndex: 0,
      },
      {
      ...
      },
      {
        ...
        options: ['Centre', 'Shooting guard', 'Power forward', 'Point guard'],
        answerIndex: 3,
      },
      {
        id: 'read_sports_01_q4',
        type: 'truefalse',
        question: 'The narrator started playing basketball at the age of eight.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
    ],
  ...
  // ─── 6. The Weather in the Czech Republic (A2) ───────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        type: 'mcq',
        question: 'What temperature can it reach in summer?',
      ...
      },
      {
        ...
        type: 'truefalse',
        question: 'It often snows in December and January.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
    ],
    ...
    questions: [
      {
        ...
        options: ['Three hours', 'Four hours', 'Five hours', 'Six hours'],
        answerIndex: 0,
      },
      {
        id: 'read_media_01_q2',
        ...
        options: ['Cooking', 'Programming', 'Playing musical instruments', 'Drawing'],
        answerIndex: 3,
      },
      {
        id: 'read_media_01_q3',
      ...
      },
      {
        id: 'read_media_01_q5',
        type: 'truefalse',
        question: 'According to the text, spending too much time online can cause problems with sleep.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
    ],
  ...
  // ─── 8. Protecting the Environment (B1) ──────────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: ['David Attenborough', 'Jane Goodall', 'Elon Musk', 'Greta Thunberg'],
        answerIndex: 3,
      },
      {
        id: 'read_nature_01_q5',
        type: 'truefalse',
        question: 'According to the text, all Czech schools organise tree-planting events.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
    ],
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          ...
          'Only your name, phone number and a photo',
          'Your hobbies, favourite subjects and a photo',
          'Your address and your parents\' names and jobs',
        ],
        answerIndex: 0,
      },
      {
        ...
        options: [
          'Memorise your CV and practise reading it aloud',
          'Research the company and prepare answers to common questions',
          'Ask a friend to come to the interview with you',
      ...
      },
      {
        id: 'read_work_01_q5',
        type: 'truefalse',
        question: 'According to the text, you always need to write a cover letter when you apply for a job.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
    ],
  ...
  // ─── 10. Living in a City vs. the Countryside (B1) ───────────────────
  {
    ...
    questions: [
      ...
      },
      {
        ...
        options: [
          'There is too much noise from traffic',
          'The air is often polluted',
          'There are fewer services and commuting is harder',
          'Houses are small and expensive',
        ],
        answerIndex: 2,
      },
      {
