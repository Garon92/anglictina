...
export const CONDITIONAL_TYPES: ConditionalType[] = [
  {
    ...
    examples: [
      ...
      { en: 'If it rains, the grass gets wet.', cs: 'Když prší, tráva zmokne.' },
  ...
  },
  {
    ...
    examples: [
      ...
      { en: 'If we hurry, we won\'t miss the bus.', cs: 'Když si pospíšíme, nezmeškáme autobus.' },
    ],
  ...
  },
  {
    ...
    examples: [
      ...
      { en: 'If he hadn\'t eaten so much, he wouldn\'t have felt sick.', cs: 'Kdyby toho býval tolik nesnědl, nebylo by mu špatně.' },
    ],
...
export const CONDITIONAL_EXERCISES: ConditionalExercise[] = [
  ...
  // mcq (6)
  {
    ...
    answer: 'get burned',
    options: ['get burned', 'had got burned', 'would get burned', 'got burned'],
  ...
  },
  {
    ...
    answer: 'cry',
    options: ['cry', 'had cried', 'would cry', 'cried'],
  ...
  },
  {
    ...
    conditionalType: 'mixed',
    level: 'B1',
    prompt: 'He doesn\'t speak Czech. If he ___ (speak) Czech, he would have understood the instructions yesterday.',
    answer: 'spoke',
  ...
  },
  {
    ...
    answer: "weren't",
    options: ['weren\'t', 'hasn\'t been', 'isn\'t', 'won\'t be'],
    explanationCs: 'Smíšený kondicionál – přítomná vlastnost (weren\'t so lazy = obecně není tak líný) → minulý výsledek (would have finished).',
  },
  {
    id: 'cond_m_11',
    type: 'mcq',
  ...
  },
  {
    ...
    answer: 'were',
    options: ['were', 'has been', 'is', 'will be'],
