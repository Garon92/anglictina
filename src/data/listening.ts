...
export const LISTENING_EXERCISES: ListeningExercise[] = [
  ...
  // ─── A1 COMPREHENSION (listen_05–listen_07) ────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_05_q2',
        type: 'truefalse',
        question: 'The next train leaves at ten.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
    ],
  },
  {
    ...
    topic: 'weather',
    script:
      'It is sunny today. It is warm outside. I don\'t need a jacket. I am going to go to the park.',
    questions: [
      {
        id: 'listen_06_q1',
        type: 'mcq',
    ...
    questions: [
      {
        ...
        options: ['Watch TV', 'Cook dinner', 'Play games', 'Read books'],
        answerIndex: 3,
      },
      {
        id: 'listen_07_q2',
        ...
        options: ['In the morning', 'Every evening', 'After lunch', 'At weekends'],
        answerIndex: 1,
      },
    ],
  },
  ...
  // ─── A2 COMPREHENSION (listen_16–listen_22) ────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_16_q2',
        type: 'truefalse',
        question: 'Tom has breakfast with his family.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_18_q2',
        type: 'truefalse',
        question: 'They waited about half an hour for their food.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
    ],
    ...
    questions: [
      {
        ...
        options: ['New shoes', 'A jacket', 'A bag', 'A dress'],
        answerIndex: 0,
      },
      {
        id: 'listen_19_q2',
    ...
    questions: [
      {
        ...
        options: ['At a school', 'At a hospital', 'At an office', 'At a hotel'],
        answerIndex: 3,
      },
      {
        id: 'listen_20_q2',
        ...
        options: ['At four', 'At five', 'At six', 'At eight'],
        answerIndex: 0,
      },
      {
        id: 'listen_20_q3',
    ...
    questions: [
      {
        ...
        options: ['Twice a week', 'Three times a week', 'Four times a week', 'Every day'],
        answerIndex: 0,
      },
      {
        id: 'listen_21_q2',
        type: 'truefalse',
        question: 'The English class is on Monday and Friday.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
    ],
  },
  {
    ...
    topic: 'freetime',
    script:
      'At weekends I usually go cycling with my friend Mark. We ride along the river for about an hour. After that, we stop at a café and have coffee and cake. It is our favourite weekend activity.',
    questions: [
      {
        id: 'listen_22_q1',
        type: 'mcq',
        question: 'What do the speaker and Mark usually do at weekends?',
      ...
      },
      {
        id: 'listen_22_q2',
        type: 'truefalse',
        question: 'They ride along the river.',
        options: ['True', 'False'],
        answerIndex: 0,
      },
      {
    ...
    questions: [
      {
        id: 'listen_23_q1',
        type: 'fill',
        question: 'Please ___ your seatbelt. The plane is about to take off.',
        answer: 'fasten',
      },
    ],
  },
  ...
  // ─── B1 COMPREHENSION (listen_30–listen_35) ────────────────────────
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_30_q2',
        type: 'truefalse',
        question: 'According to the speaker, delivery always takes several days.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_31_q2',
        type: 'truefalse',
        question: 'In the hybrid model, employees work from home four days a week.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_32_q2',
        type: 'truefalse',
        question: 'Experts say you need to practise for at least an hour a day.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
      {
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_33_q2',
        type: 'truefalse',
        question: 'Doctors recommend keeping your bedroom warm.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
    ],
    ...
    questions: [
      {
        ...
        options: ['In Paris', 'In Marseille', 'In Lyon', 'In Nice'],
        answerIndex: 3,
      },
      {
        id: 'listen_34_q2',
  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        id: 'listen_35_q2',
        type: 'truefalse',
        question: 'Many cities organise free runs once a month.',
        options: ['True', 'False'],
        answerIndex: 1,
      },
      {
