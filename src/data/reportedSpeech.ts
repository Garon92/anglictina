...
export const REPORTED_SPEECH_RULES: ReportedSpeechRule[] = [
  ...
  },
  {
    ...
    explanationCs: 'Přítomný průběhový čas (am/is/are + -ing) se mění na minulý průběhový čas (was/were + -ing). Minulý průběhový čas (was/were + -ing) se dále mění na předminulý průběhový (had been + -ing).',
  },
  {
    id: 'rs_rule_03',
  ...
  },
  {
    ...
    explanationCs: 'Časové a místní výrazy se mění: today → that day, tomorrow → the next day / the following day, yesterday → the day before / the previous day, next week → the following week, last week → the week before / the previous week, now → then, here → there, this → that, these → those, ago → before.',
  },
  {
    id: 'rs_rule_10',
